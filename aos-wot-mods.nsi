...
section "uninstall"
    ...
    Delete "$INSTDIR\res_mods\0.9.1\gui\maps\icons\library\BgBattleResultIconVictory-1.png"
    Delete "$INSTDIR\res_mods\0.9.1\gui\maps\icons\library\BgBattleResultIconDraw-1.png"
    Delete "$INSTDIR\res_mods\0.9.1\gui\maps\icons\library\BgBattleResultIconDefeat-1.png"
    Delete "$INSTDIR\res_mods\0.9.1\gui\gui_sounds.xml"
    Delete "$INSTDIR\res_mods\0.9.1\gui\flash\waiting.swf"
    ...
    Delete "$INSTDIR\res_mods\0.9.1\gui\flash\logos.swf"
    ...
    Delete "$INSTDIR\aos-wot-mods\botdetect_report\wiped account.jpg"
    Delete "$INSTDIR\aos-wot-mods\botdetect_report\report_battle.jpg"
    Delete "$INSTDIR\aos-wot-mods\botdetect_report\map_loading.jpg"
